...
class CalculadoraGeo {
    ...
    GeogToUTM() {
        ...
        util.DegToRad(lon)
        var zone = document.getElementById("FlatBox").value;
        var result = [];
        util.LatLonToUTMXY(lat, lon, zone, result);
        document.getElementById("x").value = result[0];
        document.getElementById("y").value = result[0]*zone;
    }
}
 
var calculadora = new CalculadoraGeo();